...
We aim to develop and share knowledge and good Open Research practices that foster, enable, and encourage anyone in
Sheffield to Undertake Ooen Research
:::
...
Research. But it is possible for data sources to be made available under the FAIR principles using resources such as
figshare to make data and generate Digital Object Identifiers available, careful consideration can be given to the data
formats in which study material are collected, stored and curated.
:::
